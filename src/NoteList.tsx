...
function NoteList({ availableTags, notes, onDeleteTag, onUpdateTag }: NoteListProps) {
  ...
  return (
    <>
      ...
      <EditTagsModal show={editTagsModalIsOpen} onDeleteTag={onDeleteTag} onUpdateTag={onUpdateTag} handleClose={()=> setEditTagsModalIsOpen(false)} availableTags={availableTags} />
    </>
  );
}
